...
def test_field_validation():
    ...
    try:
        from fastmcp.contrib.elicitation_forms.fields import (
            StringField, IntegerField, BooleanField, EnumField, EnumFieldChoices
        )
...
def test_form_definition():
    ...
    try:
        from fastmcp.contrib.elicitation_forms import (
            ElicitationForm, StringField, IntegerField, BooleanField, EnumField, EnumFieldChoices
        )
        ...
        assert all(field in form._fields for field in ["name", "age", "active", "choice"])
...
def test_form_validation():
    ...
    try:
        from fastmcp.contrib.elicitation_forms import (
            ElicitationForm, StringField, IntegerField, ValidationError
        )
...
def test_form_inheritance():
    ...
    try:
        from fastmcp.contrib.elicitation_forms import (
            ElicitationForm, StringField, IntegerField, EnumFieldChoices, EnumField
        )
        ...
        assert all(field in extended._fields for field in ["name", "choice", "email", "age"])
...
def test_edge_cases():
    ...
    try:
        from fastmcp.contrib.elicitation_forms import (
            ElicitationForm, StringField, ValidationError
        )
...
def test_rpn_forms():
    ...
    try:
        ...
        from rpn_mcp_server.server import (
            RPNErrorCorrectionForm, RPNPreferencesForm, RPNHelpRequestForm,
            OutputFormatChoices, SkillLevelChoices, HelpTopicChoices
        )
        ...
        expected_topics = {
            "basic_operations", "stack_operations", "advanced_math",
            "precision_control", "memory_operations", "examples"
        }
