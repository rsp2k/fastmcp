...
def test_contrib_modules_directly():
    ...
    try:
        ...
        string_field = StringField(title="Test", min_length=3, max_length=10)
        ...
        expected = {"type": "string", "title": "Test", "minLength": 3, "maxLength": 10}
...
def test_manual_functionality():
    ...
    try:
        ...
        def create_string_schema(
            title, description, min_length=None, max_length=None, default=None
        ):
...
def main():
    ...
    if passed == total:
        ...
        print(
            f"⚠️  {passed}/{total} direct tests passed. Core logic works but imports need FastMCP environment."
        )
