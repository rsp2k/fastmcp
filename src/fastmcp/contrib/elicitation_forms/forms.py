...
class ElicitationForm(metaclass=ElicitationFormMeta):
    ...
    async def elicit(
        self, ctx: Context, message: str | None = None
    ) -> ElicitationResult:
        """
        ...
        try:
            ...
            if result.action == "accept" and result.content:
                ...
                try:
                    ...
                    await self._call_handler("on_accepted", cleaned_data)

                    return ElicitationResult(
                        action="accept", data=cleaned_data, form=self
                    )
    ...
    async def _call_handler(self, handler_name: str, *args, **kwargs) -> Any:
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if not hasattr(self, "cleaned_data") or name in (
            "cleaned_data",
            "_fields",
            "_field_overrides",
            "message",
